...
import GAME_TOURNAMENT_ABI from './gameTournament.abi.json';
...
import { ContractContext as GameTournamentContract } from './gameTournament';
...
export function stakingLockContract(web3: Web3) {
...
export function gameTournamentContract(web3: Web3) {
    return new web3.eth.Contract(GAME_TOURNAMENT_ABI as any, ADDRESSES.gameTournament) as any as GameTournamentContract;
}
