...
def main():
    ...
    game2 = Game2.deploy(addresses['resource'], addresses['phi'], lending.address, 0, 51, 150, {'from': deployer})
    games['1'] = game2.address
    game2.transferOwnership('0xd4AE6402155Ec508C6Ca7Dd833fd355c6eDd1c14', {'from': deployer})

    game3 = Game2.deploy(addresses['resource'], addresses['phi'], lending.address, 0, 151, 1000, {'from': deployer})
